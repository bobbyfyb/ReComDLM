...
def get_model(
    ...
    # For checkpointed QLoRA, checkpointed blocks need grad-carrying inputs.
    if load_in_4bit and getattr(model_args, "lora", False):
        ...
        if trainable_params == 0:
            raise ValueError(
                "LoRA is enabled but no trainable parameters were found. "
                "Check model_args.target_modules/modules_to_save."
            )
